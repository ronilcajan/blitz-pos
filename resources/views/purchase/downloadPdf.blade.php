            ...
            <thead>
                <tr>
                    ...
                    <td>
                        ...
                        <p style="color: #5E6470;">Address: {{ $purchase->store->address }}</p>
                    </td>
                    <td style="text-align:right; padding: 35px 16px">
                        <p style="color: #5E6470;">Order ID: {{ $purchase->tx_no }}</p>
                ...
                <tr class="itemfooter">
                    ...
                    <td style="text-align: right">
                        ...
                        <p style=" text-align: right !important; ">
                            {{ Number::format($purchase->quantity, precision: 2) }}
                        </p>
                    </td>
                </tr>
                <tr class="itemfooter">
                    ...
                    <td style="text-align: right">
                        ...
                        <p style=" text-align: right !important; ">
                            {{ $purchase->store->currency }}
                            {{ Number::format($purchase->total, precision: 2) }}
                        </p>
                    </td>
                </tr>
                <tr class="itemfooter">
                    ...
                    <td style="text-align: right">
                        ...
                        <p style=" text-align: right !important; ">
                            {{ $purchase->store->currency }}
                            {{ Number::format($purchase->discount, precision: 2) }}
                        </p>
                    </td>
                </tr>
