...
<template>
    ...
    <div class="flex-grow">
        <div class="flex flex-col gap-5 md:flex-row">
            ...
            <div class="w-full md:w-2/3 gap-4 flex flex-col">
                <div class="shadow card bg-base-100 rounded-sm">
                    <div class="card-body">
                        ...
                        <div class="flex flex-col gap-5 mt-5">
                            ...
                            <div class="flex gap-4 items-baseline flex-wrap">
                                ...
                                <span class="text-2xl text-gray-500 line-through" v-if="product.price.discount_type != 'none'">
                                    {{ $page.props.auth.user.currency }} 
                ...
                <div class="rounded-sm">
                    <div role="tablist" class="tabs tabs-lifted tabs-md">
                        <input type="radio" name="my_tabs_2" role="tab" class="tab font-semibold text-primary" aria-label="Description" />
                        ...
                        <input
                            ...
                            name="my_tabs_2"
                            role="tab"
                            class="tab font-semibold text-primary"
                        ...
                        <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                            ...
                            <div class="flex flex-col mt-3">
                                ...
                                <span class="text-xl font-semibold" v-if="product.price.discount_type === 'percentage'">
                                    {{ parseInt(product.price.discount_rate) }} %
                                </span>
                                <span class="text-xl font-semibold" v-else>
                                    {{ $page.props.auth.user.currency }}
                            ...
                            <div class="flex flex-col mt-3">
                                ...
                                <span class="text-xl font-semibold" v-if="product.price.tax_type === 
                                'percentage'">
                        ...
                        <input type="radio" name="my_tabs_2" role="tab" class="tab font-semibold text-primary" aria-label="Sales" />
