...
const form = useForm({
    ...
    discount: props.product.price?.discount_price,
    discount_price: props.product.price?.discount_price,
    manual_percentage: props.product.price?.discount_price,
...
const calculateSalePrice = () => {
    ...
    const Total = parseFloat(base_price) + parseFloat(markup_price);
...
const submitUpdateForm = () => {
	form.post(`/products/update`,
    {
		...
		preserveScroll: true,
  		onSuccess: () => {
			useToast().success(`Product has been updated successfully!`, {
				position: 'top-right',
				duration: 3000,
				dismissible: true
			});
...
<template>
    <Head :title="title" />
    <form @submit.prevent="submitUpdateForm" class="w-full" id="createProductForm">
                    ...
                    <div class="flex justify-between gap-2 flex-col lg:flex-row">
                        ...
                        <div class="flex justify-between gap-3 flex-col md:flex-row">
                            ...
                            <NavLink href="/products" class="btn btn-sm">
                                ...
                                Cancel</NavLink>
                            <SuccessButton form="createProductForm"
                                class="btn btn-sm"
