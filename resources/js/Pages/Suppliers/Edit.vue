        ...
        <div class="card-body grow-0">
            <div class="flex justify-between gap-2">
                <h2 class="card-title grow text-sm">
                    <a class="link-hover link">Supplier Information</a>
                </h2>
            </div>
            <form @submit.prevent="submitUpdateForm ">
                ...
                <div class="mb-3">
                    <div class="relative rounded-full" v-if="props.supplier.logo">
                        <img width="60" class="rounded-md" :src="props.supplier.logo" alt="logo">
                    </div>
                ...
                <div class="mt-6 flex justify-end">
                    <NavLink href="/suppliers" class="btn">Cancel</NavLink>
                    <SuccessButton
                        class="ms-3"
