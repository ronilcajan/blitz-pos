...
const submitUpdateForm  = () => {
	form.post('/suppliers/update',{
		replace: true,
		preserveScroll: true,
  		onSuccess: () => {
			useToast().success(`Supplier has been updated successfully!`, {
				position: 'top-right',
				duration: 3000,
				dismissible: true
			});
                ...
                <div class="card bg-base-100 shadow">
                    <div class="card-body grow-0 ">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label v-if="!props.supplier.logo" for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg">
                            ...
                            <img :src="props.supplier.logo" v-if="props.supplier.logo" alt="product image">
                        </div>
                        <div class="mt-3">
