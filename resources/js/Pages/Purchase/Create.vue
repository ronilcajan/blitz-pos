...
const createOrderFromProduct = (product) => {
    return {
        ...
        qty: 1,
        price: parseFloat(product.price?.discount_price ?? 0.00).toFixed(2),
        image: product.image,
        get total() {
                                ...
                                <div class="relative w-full">
                                    ...
                                    <ul tabindex="0" class="dropdown-content z-[1] bg-base-100 shadow mt-4 w-full">
                                        <li class="p-2 px-5 border-b">
                                            <button class="text-gray-600 font-semibold text-primary">
                                                + Create product
                                            </button>
                                        </li>
                                        <li class="p-2 px-3 border-b cursor-pointer hover:bg-slate-100" v-for="product in products.data" :key="product.id">
                                            <div class="flex items-center justify-between gap-1">
                                                ...
                                                <div class="flex items-center gap-1">
                                                    <span class="text-accent">{{ product.stocks + " " + product.unit }}</span>
                                                </div>
                                            </div>
                            ...
                            <tbody>
                                <tr v-for="(order, index) in orders" :key="order.id">
                                    ...
                                    <td>
                                        ...
                                        x
                                        <NumberInput type="number" v-model="order.price" class="input input-sm w-20" />
                                    </td>
