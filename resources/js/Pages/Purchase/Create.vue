...
//                     details: props.products.size,
//                     price: props.products.stock?.unit_price,
                ...
                <div class="flex gap-2 flex-col sm:flex-row">
                    ...
                    <div class="w-full mb-3">
                        ...
                        <div class="relative sm:w-60 w-full">
                            ...
                            <input placeholder="Search for barcode" v-model="search" class="input pl-8 input-bordered input-sm w-full max-w-xs"/>
                    ...
                    <tr v-for="order in orders" :key="order.id">
                        ...
                        <td>
                            <div class="flex gap-2 grow flex-col md:flex-row">
                                <img v-if="order.image" class="h-14 w-14 shrink-0 rounded-btn" width="56" height="56" :src="order.image" alt="Product">
                                <div class="flex flex-col gap-1">
                                    <div class="text-sm">{{ order.product }}</div>
                                <div class="text-xs text-base-content/50">{{ order.details }}</div>
                                    <div class="font-mono text-xs text-base-content/50">{{ order.price }}</div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <CounterInput :initialValue="3"/>
                            <div class="block md:hidden ">
                                <p class="mt-5">Discount <br>P 3023.23</p>
                                <p class="mt-5">Sub-total <br>P 3023.23</p>
                                <button @click="deleteCustomerForm(order.id)" class="text-orange-900 hover:text-orange-600 mt-5">
                        ...
                        <td class="hidden sm:table-cell">P 3023.23</td>
                        <td class="hidden sm:table-cell">
                            <span class="">P 3023.23</span>
                        </td>
                        <td class="hidden sm:table-cell">
                            <button @click="deleteCustomerForm(order.id)" class="text-orange-900 hover:text-orange-600 mt-5">
                                    <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
