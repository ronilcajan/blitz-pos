<template>
    <div id="home" class=" pt-[120px] md:pt-[130px] lg:pt-[160px] bg-primary">
        <div class="container">
            <div class="flex flex-wrap items-center -mx-4">
                <div class="w-full px-4">
                    <div class="hero-content text-center max-w-[780px]
                     mx-auto
                     wow
                     fadeInUp flex flex-col
                     "
                        data-wow-delay=".2s">
                        <h1
                            class="text-white font-bold text-3xl sm:text-5xl
                        md:text-[45px]
                        leading-snug
                        sm:leading-snug
                        md:leading-snug
