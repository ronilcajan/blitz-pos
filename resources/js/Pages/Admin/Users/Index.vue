...
<template>
    ...
    <div class="flex flex-wrap items-center justify-end gap-3 mb-5">
        <CreateButtonLink href="/admin/users/create">New user</CreateButtonLink>
        <DownloadButton :href="route('user.export')">Export</DownloadButton>
        <StatusFilter v-model="status" />
    </div>
    <section class="w-full col-span-12 mb-5 shadow-sm stats stats-vertical xl:stats-horizontal">
    ...
    <section class="col-span-12 overflow-hidden shadow bg-base-100 rounded-xl">
        <div class="p-4 grow-0 ">
            <div class="flex flex-col-reverse justify-between gap-5 sm:flex-row">
                    ...
                    <tr v-for="user in users.data" :key="user.id">
                        ...
                        <td class="table-cell w-10">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <div class="flex gap-2 text-sm font-bold">{{ user.name }}
                                        <Link :href="route('user.impersonate', user.id)" class="text-xs text-primary" v-show="$page.props.auth.user.isSuperAdmin">Impersonate</Link>
                                    </div>
                        ...
                        <td class="hidden sm:table-cell">
                            <div class="gap-2 badge badge-primary">
                            {{ user.role }}
                            </div>
                        </td>
                        <td class="hidden sm:table-cell">
                        ...
                        <td>
                            <div class="flex items-center justify-center space-x-2">
                                <Link :href="`/admin/users/${user.id}/edit`" class=" hover:text-green-500">
