...
<template>
    <div class="flex items-center justify-center w-full relative">
        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg">
            <a href="#" class="bg-red-500 text-white rounded-full p-1 hover:bg-red-700 absolute top-2 right-2 transform translate-x-1/2 -translate-y-1/2 z-50" @click.prevent="removeImage" v-if="image_preview">
