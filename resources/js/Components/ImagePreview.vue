...
<template>
    ...
    <a href="#" class="bg-red-500 text-white rounded-full p-1 hover:bg-red-700 absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 z-20" @click.prevent="removeImage" v-if="image_preview">
