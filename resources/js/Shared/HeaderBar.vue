...
<template>
	...
	<!-- header -->
	<header class="flex items-center justify-between col-span-12 gap-2 lg:gap-1">
		<div>
			<label for="my-drawer" class="btn btn-square btn-ghost drawer-button lg:hidden">
				<svg data-src="https://unpkg.com/heroicons/20/solid/bars-3.svg" class="w-5 h-5"
					xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
					data-slot="icon" data-id="svg-loader_1">
		...
		<div>
			...
			<div class="z-10 dropdown-end dropdown">
				...
				<div tabindex="0" class="avatar placeholder btn btn-circle btn-ghost online"
					v-show="!$page.props.auth.user.avatar">
	...
	<header class="flex col-span-12 gap-2 mt-5 lg:gap-4">
		<div v-show="$page.props.flash.message" role="alert" class="alert alert-success text-white">
