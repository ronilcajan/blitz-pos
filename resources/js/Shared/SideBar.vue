    ...
    <aside class="z-10 drawer-side" >
		...
		<nav class="flex flex-col min-h-screen gap-2 px-6 py-10 overflow-y-auto w-72 bg-base-100">
			...
			<ul class="gap-2 mt-4 menu">
                ...
                <li>
					<NavLink :active="$page.component.startsWith('Pos')" :href="route('pos')">
				...
				<li >
					<details :open="$page.component.startsWith('Inventory') || $page.component.startsWith('InhouseStockTransaction')" >
						<summary >
						...
						<ul class="mt-2">
							...
							<li>
								<NavLink href="/in_house" :active="$page.component.startsWith('InhouseStockTransaction/')">In-house Stocks</NavLink>
							</li>
						</ul>
					</details>
				</li>
                <li >
					<details :open="$page.component.startsWith('Expenses')" >
						...
						<ul class="mt-2">
							<li class="mb-2">
								<NavLink href="/expenses" :active="$page.component.startsWith('Expenses/')">
									Expenses</NavLink>
							</li>
							<li>
                ...
                <li>
					<NavLink :active="$page.component.startsWith('Sale')" href="/sales">
                ...
                <li>
					<NavLink :active="$page.component.startsWith('Delivery')" href="/deliveries">
				...
				<li>
					<NavLink :active="$page.component.startsWith('Suppliers')" href="/suppliers">
				...
				<li v-show="$page.props.auth.user.isSuperAdmin">
					...
					<li v-show="!$page.props.auth.user.isStaff && !$page.props.auth.user.isAdmin">
						<details details :open="$page.component.startsWith('Users') || $page.component.startsWith('Store') || $page.component.startsWith('Logs')" >
							<summary>
